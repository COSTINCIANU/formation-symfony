...
// ici la class RegistrationType herite de ApplicationType
// qui et declare dans Form
...
{  
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('email', EmailType::class, $this->getConfiguration("Email", "Vore email..."))
            ...
            ->add('introduction', TextType::class, $this->getConfiguration("Intoduction", "Presentez vous en quelques mots...."))
